# Visa Types for Foreigners in Korea: A Complete Guide

> Last updated: 2026-04-10 | Sources: HiKorea (hikorea.go.kr), Korea Immigration Service, Ministry of Justice, r/Living_in_Korea, r/teachinginkorea, Korea4Expats, Seoul Global Center, KIIP (social-integration.go.kr), audience-pulse-2026-04-10

---

## Quick Answer

Korea has dozens of visa types, but most foreigners fall into one of about 10 categories. The most common confusion: **which visa lets you do what**, **how to switch between them**, and **what happens if you mess up a deadline**. The consequences of visa violations are real -- fines, deportation, and re-entry bans. When in doubt, call **1345** (foreigner helpline) before acting.
...
1. **Gather documents** (allow 2-4 weeks for apostilles):
...
2. **Submit at Korean embassy/consulate** in your home country (cannot apply from inside Korea on a tourist visa)

3. **Processing time:** 2-4 weeks (varies by embassy; some report up to 6 weeks)
...
1. **Income below threshold** -- $65K means gross, not net. Some embassies interpret strictly
2. **Freelancer income not clearly documented** -- inconsistent invoices without matching bank deposits
3. **Insurance doesn't meet requirements** -- travel insurance is NOT accepted; must be proper health coverage
4. **Criminal background check issues** -- must be apostilled, recent (within 6 months), from country of citizenship
5. **Suspicion of Korean-sourced income** -- any indication you'll work for Korean clients will get denied
6. **Previously overstayed in Korea** -- even a few days can disqualify you
...
1. Get a recommendation letter from your university's international student office
2. Book appointment at immigration (HiKorea) or visit your local office
3. Bring: passport, ARC, enrollment certificate, recommendation letter, employment details (employer name, work type, location, hours)
4. Fee: 없음 (free for first issuance)
5. Processing: same day to 3 business days
6. Permit is tied to a specific employer -- if you change jobs, update at immigration
...
6. Processing: 1-3 business days
...
1. Book appointment at immigration via HiKorea
2. Bring: passport, ARC, current visa documents, new visa documents (job offer, etc.)
3. Fee: 100,000 KRW (visa status change)
4. Processing: 2-4 weeks (can be longer)
...
**Q: Can I work while on a student visa (D-2)?**
A: Yes, but only with a Part-time Work Permit from immigration. Hours: 20/week during semester, unlimited during breaks. Working without the permit is illegal and can result in visa cancellation.

**Q: My employer hasn't sponsored my visa yet. Can I start working?**
A: No. You must have the correct visa BEFORE starting work. Working on a tourist visa or without proper status is illegal for both you and the employer.

**Q: I got married to a Korean. What visa do I get?**
A: F-6 (Marriage Migration). Apply at immigration with marriage certificate, spouse's documents, and proof of relationship. After 2 years (and meeting requirements), you can apply for F-5 (permanent residence).

**Q: Can I leave and re-enter Korea while my visa application is processing?**
A: Check with immigration. Some pending applications allow travel with a Re-entry Permit, others don't. Leaving Korea during processing can void your application.

**Q: I'm on a tourist visa. Can I switch to a work visa without leaving Korea?**
A: No. Tourist visas (B-1/B-2) cannot be converted to work visas inside Korea. You must leave, apply at a Korean embassy in another country, and re-enter.

**Q: How long can I stay in Korea after my job ends (E-2/E-7)?**
...
**Q: Is there a point system for F-2 (resident visa)? How does it work?**
A: Yes. The F-2-7 (points-based) visa requires 80+ points across categories: age, education, Korean language (TOPIK), income, time in Korea, social integration (KIIP), and special achievements. Check the exact points table at hikorea.go.kr or ask at immigration.
